  ...
  /// 根据上下文弹出他的父级
    open(name) {
        ...
        return function(evt) {
            ...
            // 我定义了`openerElement` (DOM元素被点击，我们将在相应位置弹出窗口)
            let openerElement;
            ...
            evt.preventDefault();
            // We push our popup data to the stack. The top of the stack is always used as the data source for our current popup.
            self._stack.push({
                popupName,
                openerElement,
